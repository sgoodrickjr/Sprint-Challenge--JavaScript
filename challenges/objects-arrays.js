...
zooAnimals.forEach(indexItem => {
  displayNames.push(`Name: ${indexItem.animal_name} \n Scientific: ${indexItem.scientific_name}.`);
})
...
*/
const lowCaseAnimalNames = zooAnimals.map(function(indexItem){
  return indexItem.animal_name.toLowerCase();
  });
...
*/const animalss = 
   zooAnimals.reduce((totalAnimals, animal) => {
