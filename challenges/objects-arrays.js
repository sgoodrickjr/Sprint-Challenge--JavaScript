...
*/
function displayNamesAll(strings) {
const displayNames = [];
...
*/
function convertLower(strings) {
const lowCaseAnimalNames = [];
  return strings.map(animals => {
    lowCaseAnimalNames.push(animals.toLowerCase());
  })
}
...
*/
function lowerPopulation (stringsArray) {
const lowPopulationAnimals = [];
  lowPopulationAnimals.filter(population => {
    if (population < 5) {
...
*/
function totalPop (animals) {
const populationTotal = 0;
  return animals.reduce((totalAnimals, animal) => {
    return totalAnimals += animal;
  })
}
